    ...
    <div className="w-full p-4">
      <div className="bg-white shadow-lg rounded-xl p-8 border border-gray-200">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <h1 className="text-3xl font-extrabold text-brand-700 dark:text-brand-400" style={{ color: '#2d2d2d' }}>All Subcategories</h1>
          <input
            type="text"
        ...
        {loading ? (
          ...
          sorted.length > 0 ? (
            ...
            <div className="flex justify-center items-center h-64" style={{ color: '#2d2d2d' }}>No subcategories found.</div>
          )
        )}
